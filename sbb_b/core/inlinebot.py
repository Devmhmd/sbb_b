...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧ꧑ᥲ️ᥱ᥉ƚℛ᥆ⵧⵧⵧⵧⵧ⍣**\n[꧑ᥲ️ᥱ᥉ƚℛ᥆ ᥴ꧑ძ 🧸♥](https://t.me/APP_YOUTUBE)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/APP_YOUTUBE"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/APP_YOUTUBE"),
                Button.url(
                    "المطور",
                    "t.me/RR7PP",
                ),
        ...
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[꧑ᥲ️ᥱ᥉ƚℛ᥆ ᥴ꧑ძ 🧸♥](https://t.me/APP_YOUTUBE)",
            description="لتنصيبه لك",
            url="t.me/APP_YOUTUBE",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
